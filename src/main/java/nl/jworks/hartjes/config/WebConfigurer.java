package nl.jworks.hartjes.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import nl.jworks.hartjes.web.filter.CachingHttpHeadersFilter;
import nl.jworks.hartjes.web.filter.StaticResourcesProductionFilter;
import nl.jworks.hartjes.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "nl.jworks.hartjes.web.websocket");
