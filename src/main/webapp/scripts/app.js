...
var hartjesApp = angular.module('hartjesApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'hartjesAppUtils', 'pascalprecht.translate', 'truncate']);
